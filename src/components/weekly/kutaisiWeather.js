...
import Kutaisi from '../dailyWeather/kutaisiDaily'
import '../styles.css'
export default class Weather extends Component{
  ...
  componentDidMount= async (e)=>{
    const api_call = await fetch(`http://api.openweathermap.org/data/2.5/forecast?id=613607&cnt=40&appid=9b41bd9f7384c942d57c1166d2943ce6`);
